...
// Sometimes takes long to produce the result
    ...
    virtual void on_mouse_button_down(int x, int y, unsigned flags)
    {
        ...
        for(i = 0; i < 1000; i++)
        {
            ...
            switch(op)
            {
                case 0: clp.operation(agg::clipper_or);           break;
                case 1: clp.operation(agg::clipper_and);          break;
                case 2: clp.operation(agg::clipper_xor);          break;
                case 3: clp.operation(agg::clipper_a_minus_b);    break;
                case 4: clp.operation(agg::clipper_b_minus_a);    break;
            }

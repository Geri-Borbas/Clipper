...
void RangeTest(const IntPoint& pt, cInt& maxrange)
{
...
bool Clipper::IsTopHorz(const cInt XPos)
{
...
void Clipper::DoMaxima(TEdge *e, cInt topY)
{
  ...
  {
    IntersectEdges( e, eMaxPair, e->top, ipNone );
  }
